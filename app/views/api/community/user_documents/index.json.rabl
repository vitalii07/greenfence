...
child @documents => 'documents' do
  attributes :id, :document_name, :authenticated, :description, :requires_authentication, :document_definition_id, :definition_value, :featured, :documentable_id, :documentable_type
